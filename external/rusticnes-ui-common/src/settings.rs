...
gradient_high = "hsv(0, 40%, 90%)"
gradient_low = "hsv(0, 95%, 80%)"

[piano_roll.settings.N163."NAMCO 2"]
gradient_high = "hsv(330, 40%, 90%)"
gradient_low = "hsv(330, 95%, 80%)"

[piano_roll.settings.N163."NAMCO 3"]
gradient_high = "hsv(172, 40%, 90%)"
gradient_low = "hsv(172, 95%, 80%)"

[piano_roll.settings.N163."NAMCO 4"]
gradient_high = "hsv(40, 40%, 90%)"
